...
I ran an electrical simulation to enhance my understanding about shift registers which is saved in the reference section of this document under Shift registers sim.
