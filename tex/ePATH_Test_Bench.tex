...
\begin{figure}[h!]
    \centering
    % First subfigure
    \begin{subfigure}[b]{0.35\textwidth} % Reduced width for smaller images
        \centering
...
The third version of the PCB was given the name 'Automated DMM tester V3-September 2025'. The only corrections to this version are the ASSR-1420-302E relay footprint and the wiring to the U2 relay that controls the resistance.The kiCAD design of the PCB is stored in the resources folder under PCB attempt 3.



\subsection{GUI}
A user friendly GUI has been developed to facilitate the testing of the ePATH PCB. The code for the GUI is on the ePATH-Test-Bench project of the company's GitHub \href{https://github.com/pathfinder-medical/ePATH-Test-Bench}{here}. This GUI is compatible with the Arduino code of all PCBs.
...
\item Some tests like the switching and inverted signal tests need to be done manually by the user and are not part of the automated test process. These could be somehow incorporated in the automated testing.
\item 
\item 
\end{itemize}